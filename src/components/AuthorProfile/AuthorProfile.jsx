          ...
          <div className={styles.sidebarContent}>
            ...
            <div className={styles.socialSection}>
              ...
              <div className={styles.socialIcons}>
                {renderSocialIcon('instagram', socialLinks.instagram, instagramIcon, 'Instagram')}
                {renderSocialIcon('twitter', socialLinks.twitter, twitterIcon, 'Twitter')}
                {renderSocialIcon('youtube', socialLinks.youtube, youtubeIcon, 'YouTube')}
              </div>
            </div>
          </div>
        )}
