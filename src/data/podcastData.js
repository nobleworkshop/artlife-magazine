export const podcastData = {
    coverImage: "/src/img/podcast-covers/cover5.png",
    author: "Fyrre",
    episodeNumber: "Ep 05",
...
export const podcastDataExample = {
    coverImage: "/src/img/podcast-covers/cover3.png",
    author: "John Doe",
    episodeNumber: "Ep 01",
    title: "The Future of Technology",
    description: "Exploring the latest trends and innovations in technology that will shape our future.",
    date: "20. March 2022",
    duration: "60 Min",
    content: [
        "Technology is evolving at an unprecedented pace, bringing both opportunities and challenges to our society. In this episode, we explore the latest developments in artificial intelligence, quantum computing, and biotechnology.",
        "The integration of AI into everyday life has become more seamless than ever before. From smart homes to autonomous vehicles, we're witnessing a transformation that will fundamentally change how we interact with technology."
    ],
